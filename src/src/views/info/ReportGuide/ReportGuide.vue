      ...
      <div class="question_Card" style="padding: 20px">
        <div style="margin-bottom: 30px">
          <div style="font-weight: bold">
            <span style="font-size: 16px; color: #438bfd">问题：</span>集团公司与子公司在同一个工业园区内，如何处理？
          </div>
          <div style="margin-top: 5px">
            子公司通常是独立的法人单位或独立的核算单位，需要单独作为报告主体参加碳排放报告核查工作。集团公司需要留存转供凭证，计算各自企业法人边界内的燃料及原材料消耗的活动数据。
          </div>
        </div>
