export const template_4 = {
    ...
    "detail": [ //后端请完整存储detail的json
            ...
            "children": [
                {
                    ...
                    "activityFactor": [ //包括1、消耗量2、脱硫剂中碳酸盐含量
                        {
                            "dataSort": 1, //活动水平数据排序
                            "isConst": false, //该值是否常数
                            "dataName": "消耗量", //该值的名字
                    ...
                    "EmissionFactorNum": 0.00, //碳酸盐的排放因子，即EmissionFactor各个子元素（碳酸盐的CO₂排放因子、转化率）相乘
                    "EmissionFactor": [ //排放因子
                        {
                            "dataSort": 1,
                            "isConst": false,
                            "dataName": "碳酸盐的CO₂排放因子",
                            "dataUnit": "吨二氧化碳/吨",
                            "dataNum": 0.00,
                            "defaultValChooseIdx": 0,
                            "defaultVal": [
            ...
            "children": [
                {
                    ...
                    "EmissionFactorNum": 0.00, //碳酸盐的排放因子，即EmissionFactor各个子元素（碳酸盐的CO₂排放因子、转化率）相乘
                    "EmissionFactorExtraCalcu": "[1]*(1-([2]*[3]))*0.001",
                    "EmissionFactor": [ //排放因子
                        {
                            "dataSort": 1,
                            "isConst": false,
                        ...
                        },
                        {
                            ...
                            "defaultVal": [
                                ...
                                {
                                    "val": 0,
                                    "description": "选择性催化还原SCR"
                                },
                                {
                                    "val": 0.8,
                                    "description": "非选择性催化还原NSCR"
                                }
                            ],
                            "dataSource": "DEFAULT" //该值来源
                        },
        ...
        }, //以上为5子类，共6个子项
        {
            ...
            "classSort": 6, //大类排序，1为最先。数字越大越靠后，不写0
            "classDataSum": 0.00, //大类累计值，企业前端计算出来，=各个小类classDataSum求和
            "canAdd": false,
            "children": [
                {
