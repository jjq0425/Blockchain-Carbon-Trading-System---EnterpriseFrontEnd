export const template_3 = {
    ...
    "taskYear": 2023,
    "enterpriseID": "", //企业ID
    "enterpriseClass": 3, //企业类别3（代表钢铁生产）
