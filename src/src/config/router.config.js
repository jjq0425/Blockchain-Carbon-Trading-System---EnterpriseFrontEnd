...
import { UserLayout, BasicLayout, BlankLayout, BindLayout } from '@/layouts'
    ...
    children: [
      ...
      // 信息上报
      {
        ...
        children: [
          ...
          {
            path: '/info/submissionDetail',
            name: 'InfoSubmissionDetail',
            component: () => import('@/views/info/infoSubmission/infoSubmissionDetail'),
            meta: { title: 'menu.info.infoSubmission.detail', keepAlive: true, },
            hidden: true
          },
      ...
      // 碳币交易
      {
        ...
        children: [
          ...
          // },
          {
            path: '/trade/tradeMarket',
            name: 'tradeMarket',
            component: () => import('@/views/trade/tradeMarket'),
            meta: { title: 'menu.trade.tradeMarket', keepAlive: true, permission: ['trade'] }
          },
          {
            path: '/trade/tradePublish',
            name: 'tradePublish',
            component: () => import('@/views/trade/tradePublish'),
