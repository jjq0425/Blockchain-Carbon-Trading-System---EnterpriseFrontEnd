...
export default {
  ...
  'account.settings.security.otp': '动态口令',
  'account.settings.security.otp-description': '动态口令相较于传统密码更为安全，因为它会实时生成，每次验证时都不相同，有效提升了账户的安全防护等级。',
  'account.settings.security.otp-modal.auth.title': '动态口令验证',
  'account.settings.security.otp-modal.create.title': '动态口令创建',
  'account.settings.security.otp-modal.setting.title': '动态口令配置',
