...
export default {
  ...
  'user.login.signup': 'Sign up an enterprise account',
  ...
  'user.forgetpassword.modal.content': 'If you forget your password, please contact your superior department to reset it.',
}
