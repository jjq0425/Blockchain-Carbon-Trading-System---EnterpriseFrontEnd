  ...
  methods: {
    ...
    async runPdf() {
      ...
      JSPDF_para.JSPDF_lineHeight =
        (doc.getLineHeight(JSPDF_para.text) / doc.internal.scaleFactor) * (doc.getLineHeightFactor() + 0.4)
      JSPDF_para.JSPDF_splittedText = doc.splitTextToSize(JSPDF_para.text, doc.internal.pageSize.getWidth() - 40)
      ...
      doc.text(20, JSPDF_para.yPos, JSPDF_para.JSPDF_splittedText, { lineHeightFactor: 1.8 })
      ...
      JSPDF_para.JSPDF_lines = JSPDF_para.JSPDF_splittedText.length // splitted text is a string array
      JSPDF_para.JSPDF_blockHeight = JSPDF_para.JSPDF_lines * JSPDF_para.JSPDF_lineHeight
      doc.text(20, JSPDF_para.yPos + 5, JSPDF_para.JSPDF_splittedText, { lineHeightFactor: 1.8 })
      JSPDF_para.yPos += JSPDF_para.JSPDF_blockHeight
      ...
      for (let i = 0; i < JSPDF_para.JSPDF_lines; i++) {
        if (JSPDF_para.yPos >= doc.internal.pageSize.height - 30) {
          doc.addPage()
          JSPDF_para.yPos = 30
        } else if (i != 0) {
          JSPDF_para.yPos = JSPDF_para.yPos + JSPDF_para.JSPDF_lineHeight
        }
        doc.text(20, JSPDF_para.yPos, JSPDF_para.JSPDF_splittedText[i])
      }
      ...
      JSPDF_para.yPos = doc.lastAutoTable.finalY
      ...
      for (let i = 0; i < JSPDF_para.JSPDF_lines; i++) {
        ...
        doc.text(115, JSPDF_para.yPos, JSPDF_para.JSPDF_splittedText[i])
      }
      ...
      for (let i = 0; i < JSPDF_para.JSPDF_lines; i++) {
        ...
        doc.text(125, JSPDF_para.yPos, JSPDF_para.JSPDF_splittedText[i])
      }
